...
public class ApplicationConstant {
    ...
    public static final String BEAN_DATASOURCE_CLINIC = "datasource-clinic";
    public static final String BEAN_JDBC_CLINIC = "jdbc-clinic";
    public static final String BEAN_JDBC_NAMED_PARAM_AXIS_WG = "jdbc-named-param-axis-wg";
